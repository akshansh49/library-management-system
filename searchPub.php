...
<table id="table">
<tr>
<td><label for="name_book">Name of the Publisher</label><span id="span">*</span>:</td>
<td><input type="text" id="author_book" name="name_pub" align="center" required></td>
</tr>
<tr>
...
if(isset($_POST['name_pub']))
{
  $author=$_POST['name_pub'];
  ...
  if(isset($sql))
  {
    ...
    if(mysql_num_rows($run_query))
    {
      ...
      $_SESSION['name_pub']=$_POST['name_pub'];
    }
    else
    {

...
<body>
<br><br><br>
	<h3 id="h3"><u>LIBRARY STAFF</u></h3>
	<h4 id="h4"><marquee><u><b>Contact the following officials for any queries....</b></u></marquee></h4><br><br>
	<center>
	<table id="contact" border="1">
	<tbody>
	<tr>
	<td style="width:500px;padding:20px;border-width:5px;">AKSHANSH NARULA
	<br><font size="3">(Librarian)</font>
	</td>
	<td style="width:500px;padding:20px">9871854219</td>
	</tr>
	<tr>
	<td style="width:500px;padding:20px">GAGAN BANSAL
	<br><font size="3">(Assistant Librarian)</font>
	</td>
	<td style="width:500px;padding:20px;border-width:5px;">9810726535</td>
	</tr>
	<tr>
	<td style="width:500px;padding:20px;border-width:5px;">ROHAN KATOCH
	<br><font size="3">(Professional Assistant)</font>
	</td>
	<td style="width:500px;padding:20px">9717161850</td>
	</tr>
	<tr>
	<td style="width:500px;padding:20px">VAIBHAV ALREJA
	<br><font size="3">(Professional Assistant)</font>
	</td>
	<td style="width:500px;padding:20px;border-width:5px;">9650996301</td>
	</tr>
	<tr>
	<td style="width:500px;padding:20px;border-width:5px;">ANMOL TANEJA
	<br><font size="3">(Jr.Assistant)</font>
	</td>
	<td style="width:500px;padding:20px">9871778425</td>
	</tr>
	<tr>
	<td style="width:500px;padding:20px">DHROOV BATRA
	<br><font size="3">(Jr.Assistant)</font>
	</td>
	<td style="width:500px;padding:20px;border-width:5px;">9760439907</td>
	</tr>
	</center>
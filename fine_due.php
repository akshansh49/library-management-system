...
<?php
  ...
  $sql_to_check="SELECT * FROM issue WHERE f_name='$name' AND date_return<'$curr_date'";
...
<?php
  while($row=mysql_fetch_array($sql_to_check_query))
  {
    $book_id=$row['b_id'];
...
else
{
  ...
  <center><strong>Hushhhh!!!</strong>No fine due.</center>
</div>
<?php
}
}
